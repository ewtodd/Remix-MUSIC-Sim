...
public:
  ...
  double GetFinalEnergy(double InitialEnergy, double PathLength);
  ...
  double GetInitialEnergy(double FinalEnergy, double PathLength);
  ...
  double GetTimeOfFlight(double InitialEnergy, double PathLength);
