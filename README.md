...
written with the help of [Claude Code](https://claude.ai/claude-code) and/or [son-of-anton](https://github.com/ewtodd/son-of-anton).
...
checks/REVIEW-...-.md
```
for a checklist (generated by [son-of-anton](https://github.com/ewtodd/son-of-anton)) of exactly what I reviewed from each set of commits.
## Build
<!---->
...
# one).
# Keys: Cathode, S0, S17, L1..L16, R1..R16 (35 channels total).
# Any
