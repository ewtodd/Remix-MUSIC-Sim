...
void RunMUSICSim_aa()
{
  ...
  evap[0] = "4He";    SRIMevap[0] = SRIMdir + "4He_in_GasIndex3_200Torr_293K.srim";
  res[0] = "10B";   SRIMres[0] = SRIMdir + "10B_in_GasIndex3_200Torr_293K.srim";
  ...
  string FileName = /*"Traces_beam_200.root";*/Form("Traces_aa_Stp%d_200.root", strip);
